...
class TestHermesRoutes(TestCase):
    def setUp(self):
        ...
        self.data = {}
        for i in data_names:
            with open("./helpers/prices/__mocks__/hermes/" + i + ".json", "r") as f:
                self.data[i] = json.loads(f.read())
        return

    @patch("api.views.HermesAPI")
    def test_that_daily_price_returns(self, mock_obj):
        mock_obj.daily_prices.return_value = self.data["daily_price"]
        response = self.c.get(
    ...
    @patch("api.views.HermesAPI")
    def test_that_suggest_returns(self, mock_obj):
        mock_obj.search_equities.return_value = self.data["search_equities"]
        response = self.c.get(
    ...
    @patch("api.views.HermesAPI")
    def test_that_fundamentals_returns(self, mock_obj):
        mock_obj.get_fundamentals.return_value = self.data["fundamentals"]
        response = self.c.get(
    ...
    @patch("api.views.HermesAPI")
    def test_that_earnings_returns(self, mock_obj):
        mock_obj.get_earnings.return_value = self.data["earnings"]
        response = self.c.get(
    ...
    @patch("api.views.HermesAPI")
    def test_that_holders_returns(self, mock_obj):
        mock_obj.get_holders.return_value = self.data["holders"]
        response = self.c.get(
    ...
    @patch("api.views.HermesAPI")
    def test_that_summary_returns(self, mock_obj):
        mock_obj.get_summary.return_value = self.data["summary"]
        response = self.c.get(
